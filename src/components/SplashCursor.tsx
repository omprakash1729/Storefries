...
export const SplashCursor: React.FC<SplashCursorProps> = ({
  ...
  useEffect(() => {
    ...
    function getSupportedFormat(gl: any, internalFormat: number, format: number, type: number, supportLinearFiltering: any) {
    ...
    function generateColor() {
      ...
      // Restrict the random hue to a premium green-to-blue gradient spectrum (from 0.35 to 0.65)
